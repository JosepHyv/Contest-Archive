...
int main()
{
	...
	/// para hacer suma de rangos con interseccion
	/// la mejor forma es sumar valores de rangos 
	//// |_____| |____| y restar la interseccion
	//// |__|___|__|  sumamos valores, y restamos la interseccion
	/// la interseccion es el max( min(y1,y2) - max(x1,x2), 0)


	int a,b,c,d;
	cin>>a>>b>>c>>d;
	cout<<(d - c) + ( b - a)  - max((min(d,b) - max(a,c)), 0 );
